...
module.exports = [
  ...
  new SlashCommandBuilder().setName('create-user').setDescription('Create a Pterodactyl user automatically and DM credentials').addUserOption(o=>o.setName('member').setDescription('Discord member').setRequired(true)).addStringOption(o=>o.setName('email').setDescription('Optional email').setRequired(false)),
  new SlashCommandBuilder().setName('createuser').setDescription('Legacy alias for automatic user creation').addUserOption(o=>o.setName('member').setDescription('Discord member').setRequired(true)).addStringOption(o=>o.setName('email').setDescription('Optional email').setRequired(false)),
  ...
  new SlashCommandBuilder().setName('create-server').setDescription('Create a server with an automatic Pterodactyl user').addUserOption(o=>o.setName('member').setDescription('Discord member — user is found or created automatically').setRequired(true)).addIntegerOption(o=>o.setName('node').setDescription('Node ID').setRequired(true)).addIntegerOption(o=>o.setName('nest').setDescription('Nest ID').setRequired(true)).addIntegerOption(o=>o.setName('egg').setDescription('Egg ID').setRequired(true)).addIntegerOption(o=>o.setName('allocation').setDescription('Allocation ID').setRequired(true)).addStringOption(o=>o.setName('name').setDescription('Server name').setRequired(true)).addIntegerOption(o=>o.setName('memory').setDescription('RAM in MB').setRequired(true)).addIntegerOption(o=>o.setName('disk').setDescription('Disk in MB').setRequired(true)).addIntegerOption(o=>o.setName('cpu').setDescription('CPU percentage').setRequired(true)).addIntegerOption(o=>o.setName('backups').setDescription('Backup limit').setRequired(false)),
