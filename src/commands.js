...
module.exports = [
  ...
  new SlashCommandBuilder().setName('create-server').setDescription('Create a Pterodactyl server')
    ...
    .addIntegerOption(o=>o.setName('user').setDescription('Pterodactyl user ID (use this OR member)').setRequired(false))
    .addUserOption(o=>o.setName('member').setDescription('Discord member whose Pterodactyl account should be used').setRequired(false))
    .addIntegerOption(o=>o.setName('backups').setDescription('Backup limit').setRequired(false)),

  new SlashCommandBuilder().setName('delete-server').setDescription('Delete a server')
    .addIntegerOption(o=>o.setName('id').setDescription('Server ID').setRequired(true))
    .addBooleanOption(o=>o.setName('force').setDescription('Force delete').setRequired(false)),
